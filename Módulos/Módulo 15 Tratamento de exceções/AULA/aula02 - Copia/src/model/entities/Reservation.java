...
public class Reservation {
    ...
    public void updateDates(Date checkIn, Date checkOut) {
        ...
        if (checkIn.before(now) || checkOut.before(now)) {
            throw new IllegalArgumentException("Erro ao reservar, somente reservas futuras.");
        }
        if (!checkOut.after(checkIn)) {
            throw new IllegalArgumentException("Erro: Saida deve ser em data posterior a entrada.");
        }
